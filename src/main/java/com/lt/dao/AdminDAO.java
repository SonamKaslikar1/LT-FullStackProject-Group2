...
public class AdminDAO implements AdminDAOInterface {
	...
	/**
	 * this method is used to add the courses by admin List of courses will be taken
	 * as parameter to add in database
	 */
	@Override
	@Transactional
	public List<Course> addCourse(List<Course> course) {
		...
		for (Course c : course) {
			jdbcConfiguration.jdbcTemplate().update(jdbcTemplateConstants.addCourseSQL, c.getCourseCode(),
					c.getCourseName(), c.getIsOffered(), c.getInstructor());
		}
	...
	/**
	 * this method is used to view the courses by admin return the list of available
	 * courses
	 */
	@Override
	@Transactional
	public List<Course> veiwCourse() {
		// TODO Auto-generated method stub
		List<Course> courseList = jdbcConfiguration.jdbcTemplate().query(jdbcTemplateConstants.viewCourseSQL,
				new CourseMapper());
		return courseList;
	}

	/**
	 * this method is used to add the professors by admin List of professors will be
	 * taken as parameter to add in database
	 */
	@Override
	@Transactional
	public List<Professor> addProfessor(List<Professor> professor) {
		...
		for (Professor p : professor) {
			jdbcConfiguration.jdbcTemplate().update(jdbcTemplateConstants.addProfessorSQL, p.getProfName(),
					p.getDepartment(), p.getDesignation(), roleConstants.professorRoleId);
		}
	...
	/**
	 * this method is used to add the student by admin List of students will be
	 * taken as parameter to add in database
	 */
	@Override
	@Transactional
	public List<Student> addStudent(List<Student> student) {
		...
		for (Student s : student) {
			jdbcConfiguration.jdbcTemplate().update(jdbcTemplateConstants.addStudentSQL, s.getName(),
					roleConstants.studentRoleId);
		}
	...
	/**
	 * this method is used to view the students by admin return the list of
	 * available students
	 */
	@Override
	@Transactional
	public List<Student> viewStudents() {
		...
		List<Student> studentList = jdbcConfiguration.jdbcTemplate().query(jdbcTemplateConstants.viewStudentSQL,
				new StudentMapper());
		return studentList;
	}

	/**
	 * this method is used to view the professor by admin return the list of
	...
	public List<Professor> veiwProfessor() {
		...
		List<Professor> professorList = jdbcConfiguration.jdbcTemplate().query(jdbcTemplateConstants.viewProfessorSQL,
				new ProfessorMapper());
		return professorList;
	}

	/**
	 * this method is used to remove the course by admin coursecode is taken as a
	 * input parameter
	 */
	@Override
	@Transactional
	...
	/**
	 * this method is used to remove the student by admin student id is taken as a
	 * input parameter
	 */
	@Override
	@Transactional
	...
	/**
	 * this method is used to remove the professor by admin professorname is taken
